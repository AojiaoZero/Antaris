...
<div id="page_contenu"><h1>Buildings</h1><div class="onglet">
			<ul>
				<li><a onclick="location.href='game.php?page=buildings&cmdd=build';" title="View buildings tab : Energie & ressources">Energie & ressources</a></li>
				<li><a onclick="location.href='game.php?page=buildings&cmdd=hangars';" title="View buildings tab : Hangars">Hangars</a></li>
				<li><a onclick="location.href='game.php?page=buildings&cmdd=militar';" title="View buildings tab : Military & scientist">Military & scientist</a></li>
			</ul>
		  </div>
		  
		  
		  {if !empty($Queue)}
		  <h2 class="titre_corps">List of buildings under construction and / or demolition</h2>
		  ...
		  <tr>
						...
						<td style="text-align : right;">
							...
							<span id="progressbar" data-time="{$List.resttime}"><span id="time" data-time="{$List.time}"></span> - <a onclick="javascript:ActionMethode.ouvrirPopUp('annuler_construction_bat_{$ID}');" title="Cancel the construction">Cancel</a></span> 
							 ...
							 - <a onclick="location.href='game.php?page=buildings&mode=Remove&listid={$List@iteration}';" title="Cancel the construction">Remove</a> 
					...
					<div id="annuler_construction_bat_{$ID}" class="popup_texte">
							<h1>Cancel construction of a building </h1> <p> you confirm the cancellation of the following construction: {$LNG.tech.{$ID}} <br />?
									</p>
				...
				<form action="" method="post">
										<input style="margin-right : 8px;" type="button" value="Comfirm" onclick="location.href='game.php?page=buildings&mode=cancel';" />
