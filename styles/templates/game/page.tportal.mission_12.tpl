...
{$missionDesc}
        ...
        <div name="conteneur_coordonnees">
            ...
            <input id="galaxy" name="galaxy" size="1" maxlength="1" value="1" type="hidden">

            <label for="System">System:</label>
         <input id="system" name="system" size="3" maxlength="3" value="{$system}" type="text"><br>
			
			<label for="position">Planet:</label>
           <input id="planet" name="planet" size="2" maxlength="3"  value="{$planet}" type="text"><br>
