...
{/if}
</div></div></div>{/foreach}<div id="nouvelle_equipe" class="equipe">		<h2>{$LNG.lm_fleettable_8} <img class="icone_creer" src="/design/image/jeu/icone/blanc/plus.png"></h2>		<a onclick="javascript:VaisseauEquipe.afficherFormulaireCreation();" class="centre">{$LNG.lm_fleettable_8} !</a>		<form id="form_creer_equipe" action="javascript:VaisseauEquipe.creerEquipe();">		<h3>{$LNG.lm_fleettable_10}</h3>			<div class="liste_vaisseau">	
