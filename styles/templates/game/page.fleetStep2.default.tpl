		...
		<tr>
        	...
        	<td class="top">
				<table border="0" cellpadding="0" cellspacing="0" width="259">
					...
					<tr style="height:20px;">
        				<td class="transparent">{$LNG.tech.904}</td>
        				<td class="transparent"><a href="javascript:maxResource('elyrium');">{$LNG.fl_max}</a></td>
        				<td class="transparent"><input name="elyrium" size="10" onchange="calculateTransportCapacity();" type="text"></td>
        			</tr>
                    <tr style="height:20px;">
