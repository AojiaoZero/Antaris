{block name="title" prepend}Paypal purchase error{/block}
{block name="content"}
<div id="page_contenu"><h1>Credit Purchase(s)</h1><div class="onglet">
			...
			<form method="post">   
                          <table>
                            ...
                            <tr>
                                <td><label for="nom">{$LNG.lm_achat_problem_5}* :</label></td>
                                <td><input id="nom" name="nom" maxlength="25" size="25" type="text"></td>
                            </tr>
                            <tr>
                                <td><label for="prenom">{$LNG.lm_achat_problem_6}* :</label></td>
                                <td><input id="prenom" name="prenom" maxlength="25" size="25" type="text"></td>
                            </tr>
                            <tr>
                                <td><label for="montant">{$LNG.lm_achat_problem_7}* :</label></td>
                                <td><input id="montant" name="montant" maxlength="8" size="6" type="text"> €</td>
                            </tr>
                            <tr>
                                <td><label for="id_transaction">{$LNG.lm_achat_problem_8}* :</label></td>
                                <td><input id="id_transaction" name="id_transaction" maxlength="30" size="30" type="text"></td>
                            </tr>
                            <tr>
                                <td colspan="2">
