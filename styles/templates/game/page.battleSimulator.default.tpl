...
<form id="form" name="battlesim">
	...
	<table style="width:80%">
		...
		<tr>
			<td> {$LNG.tech.901}: <input type="text" size="10" value="{if isset($battleinput.0.1.1)}{$battleinput.0.1.1}{else}0{/if}" name="battleinput[0][1][1]"> {$LNG.tech.902}: <input type="text" size="10" value="{if isset($battleinput.0.1.2)}{$battleinput.0.1.2}{else}0{/if}" name="battleinput[0][1][2]"> {$LNG.tech.903}: <input type="text" size="10" value="{if isset($battleinput.0.1.3)}{$battleinput.0.1.3}{else}0{/if}" name="battleinput[0][1][3]"> {$LNG.tech.904}: <input type="text" size="10" value="{if isset($battleinput.0.1.4)}{$battleinput.0.1.4}{else}0{/if}" name="battleinput[0][1][4]"></td>
		</tr>
