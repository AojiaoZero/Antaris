...
$LNG['type_mission'][12]  					= 'Negociate';
$LNG['type_mission'][13]  					= 'Attack';
$LNG['type_mission'][14]  					= 'Spying';
$LNG['type_mission'][15] 					= 'Expedition';
$LNG['type_mission'][16] 					= 'Asteroids';
$LNG['type_mission'][17] 					= 'Deploy';

$LNG['type_missionbis'][1]  					= 'Attack a planet';
$LNG['type_missionbis'][2]  					= 'ACS - Attack on cooperation';
$LNG['type_missionbis'][3]  					= 'Transport resources and / or equipment';
$LNG['type_missionbis'][4]  					= 'Based resources and / or equipment';
$LNG['type_missionbis'][5]  					= 'Transfer';
$LNG['type_missionbis'][6]  					= 'Probe a planet';
$LNG['type_missionbis'][7]  					= 'Colonize an uninhabited planet';
$LNG['type_missionbis'][8]  					= 'Recycle';
$LNG['type_missionbis'][9]  					= 'Destroy';
$LNG['type_missionbis'][10]  					= 'Missile attack';
$LNG['type_missionbis'][11]  					= 'Research of Dark matter';
$LNG['type_missionbis'][12]  					= 'Contact a people to negotiate a pact';
$LNG['type_missionbis'][13]  					= 'Attack a planet';
$LNG['type_missionbis'][14]  					= 'Probe a planet';
$LNG['type_missionbis'][15] 					= 'Expedition';
$LNG['type_missionbis'][16] 					= 'Harvest an asteroid';
$LNG['type_missionbis'][17] 					= 'Based resources and / or equipment';

$LNG['type_missionDesc'][1]  					= 'The power of an empire able to power its fleet. However, some powerful fleets can be destroyed easily due to poor strategy. Show other peoples living in this galaxy it is not enough to have the largest fleet, you also know how to use properly.<br><br>
Use your fleet to destroy and to ruin those of other nations, then intelligently use to fight against the most powerful empires you. The strategy and your combat palmarés will make you the most respected people of this universe.';
$LNG['type_missionDesc'][2]  					= 'ACS - Attack on cooperation';
$LNG['type_missionDesc'][3]  					= 'Through this mission, you can transport resources, equipment and people on one of your planets or an ally. After the mission, the vessels that make up your fleet will return to the starting planet.<br><br>
To send resources and / or equipment to another player, you must first send a pact to it. It was only after the signed agreement that you can make transfers.';
$LNG['type_missionDesc'][4]  					= 'Through this mission, you can base of resources, equipment and people only on one of the planets in your empire. Unlike the mission "Transporter resources and / or equipment", the vessels that make up the fleet sent will not return to the starting planet. Indeed, they will remain on the planet of destination (one-way with no return).<br><br>
Of course, it is necessary to develop the bunkers of your ships to be able to base a large amount of goods.';
$LNG['type_missionDesc'][5]  					= 'Transfer';
$LNG['type_missionDesc'][6]  					= 'This mission is to send a probe through the teleportation portal to retrieve the most information possible on the planet.
<br><br>
The higher the level of your spying technology, the more information about the planet are numerous and precise.
<br><br>
To perform this task you must have at least one probe on your planet.';
$LNG['type_missionDesc'][7]  					= 'It is very important to colonize other planets, it can accelerate the development of your empire as you will possess more raw material, and mining buildings in greater numbers. So your production resources will be more consistent. There is also another advantage you can rule over a larger part of the universe.<br><br>
To perform this task, you must have at least 10 scientists and 100 soldiers. Pay attention to the position of your colonies because you can colonize 9 planets in addition to your home planet. The planets are colonized the solar system 1 2700 inclusive.';
$LNG['type_missionDesc'][8]  					= 'If a space battle has just occurred and you want to recycle the remains of vessels destroyed in orbit, then simply send your vessels to ruin the planet in question. These particular vessels do not require to have a crew.<br><br>
Once in orbit around the planet, they recycle the various ruins and turn them into resources expoitables your people.';
$LNG['type_missionDesc'][9]  					= 'Destroy';
$LNG['type_missionDesc'][10]  					= 'Missile attack';
$LNG['type_missionDesc'][11]  					= 'Research of Dark matter ';
$LNG['type_missionDesc'][12]  					= 'It is possible to send a pact for a player to make transactions with him. For this you need to send an exploration team will aim to negotiate a pact between your people and the people of the visited planet.
<br><br>
The exploration team should consist of 5 to 10 diplomats and soldiers. Before you can trade, you need to wait until the end of the negotiations (the other player must accept the pact request).';
$LNG['type_missionDesc'][14] 					= 'This mission is to send a probe through the teleportation portal to retrieve the most information possible on the planet.
<br><br>
The higher the level of your spying technology, the more information about the planet are numerous and precise.
<br><br>
To perform this task you must have at least one probe on your planet.';
$LNG['type_missionDesc'][15] 					= 'Expedition';
$LNG['type_missionDesc'][17]  					= 'This mission allows to pass through the gate teleportation equipment and / or resources. Once sent, resources and equipment will arrive on the planet of destination. This means of transport is very fast.<br><br>
<b>You can send resources and materials on your own planets</b>';
$LNG['type_missionDesc'][13]  					= 'It is important to protect its people from enemy attacks, and as the saying a famous saying: "The best defense is a good offense." You can become a powerful ruler of the universe if you can show your attack power to other peoples.<br><br>It is possible to gain resources through this mission by sending specialized devices such as small carriers, major airlines but also the speeders.<br><br><b>Be careful, if you lose the fight then you will also lose all sent specialized equipment.</b>';
...
$LNG['gl_no_deuterium_to_view_galaxy']		= 'You dont have enough elyrium to view the galaxy';
...
$LNG['mg_type'][3]                          = 'Battles report(s) through the space';
$LNG['mg_type'][4]                          = 'System messages';
$LNG['mg_type'][5]                          = 'Report(s) return of fleet';
$LNG['mg_type'][6]                          = 'Battles report(s) through the portal';
$LNG['mg_type'][7]                          = 'Other messages';
$LNG['mg_type'][8]                          = 'Saved messages';
$LNG['mg_type'][15]                         = 'Explorations messages';
...
$LNG['css_account_banned_expire']           = 'Your account will be unbanned on %s!';
...
$LNG['sys_account_deleted']        	 			= '<span class="rouge">The account with the username « %s » was deleted.</span><br>
...
$LNG['bs_steal_raport']   					= "Needed to capture the resources: %s %s or %s %s.";
