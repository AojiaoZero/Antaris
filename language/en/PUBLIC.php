...
$LNG['registerErrorCaptchas']		= 'The security code you entered is incorect!';
$LNG['registerErrorUniClosed']		= 'The registration is closed in this universe.!';
$LNG['cannottakeover']	= 'You can not resume this account because its still active!';
$LNG['registerErrorUsernameEmpty']	= 'You must enter a username!';
$LNG['registerErrorPlanetnametolong']	= 'The name of your planet is to long!';
$LNG['registerErrorPlanetnametoshort']	= 'The name of your planet is to short!';
$LNG['registerErrorPlanetnameEmpty']	= 'You must enter a planet name!';
...
$LNG['registerErrorPasswordLength']	= 'The password must be between 6 and 32 characters!';
$LNG['registerErroruserNameLength']	= 'The username must be between 3 and 16 characters!';
...
$LNG['registerErrorMailInvalid2']	= 'We do not accept 10 minutes email addresses';
...
$LNG['registerErrorTerms']			= 'You have to accept the terms and conditions!';
...
$LNG['registerSendComplete']		= ' <h1>Activate your account to complete</h1>
        <div style="text-align : center; padding : 10px 0px 20px 0px; font-size : 1.1em;" class="vert">
            An email has been sent to the following address : %s

            <div class="orange" style="padding-top : 5px; font-size : 0.9em;">
                IF YOU DID NOT RECEIVE THE VALIDATION EMAIL, CHECK YOUR JUNK MAIL (SPAM).
            </div>
        </div>

        <div style="text-align : justify;">
           Your account has been created. However, it is necessary to activate it from your mailbox. 
            An activation key has been sent to the email address you entered.
            If you did not receive a message in your inbox, check if it is not in your junk mail.
            <br><br>
            You have 7 days to activate your account before it is deleted definitly.
        </div>';
...
$LNG['login_error_5']				= 'Your account is permanently deleted!';
