...
$LNG['sys_mess_spy_activity'] 				= "just spy on one of your planets";
...
$LNG['sys_stat_mess'] 		         		= 'Your fleet reaches the planet %s and delivers %s %s, %s %s, %s %s and %s %s.';
...
$LNG['sys_tran_mess_owner']		 			= 'One of your fleets reaches the planet %s %s and delivers %s %s, %s %s %s %s and %s %s';
...
$LNG['sys_recy_gotten'] 					= 'Having arrived at there destination your Recyclers collect %s %s, %s %s and %s %s';
$LNG['sys_gain'] 				  			= 'Profit';
...
$LNG['sys_gain'] 				  			= 'Profit';
$LNG['sys_fleet_won'] 						= 'One of your fleets returns from a attack at the planet %s %s. You have captured %s %s, %s %s, %s %s and %s %s ';
$LNG['sys_lost'] 							= 'Losses';
