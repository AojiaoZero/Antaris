...
$LNG['registerErrorMailInvalid2']	= 'Wir wissen nicht Wegwerf-Email-Adresse akzeptieren';
...
$LNG['registerSendComplete']		= ' <h1>Aktivieren Sie Ihr Konto in Anspruch</h1>
        <div style="text-align : center; padding : 10px 0px 20px 0px; font-size : 1.1em;" class="vert">
            Ein E-Mail wurde an folgende Adresse gesendet : %s

            <div class="orange" style="padding-top : 5px; font-size : 0.9em;">
                WENN SIE NICHT ERHALTEN BESTATIGUNGS-MAIL, UBERPRUFEN SIE UNERWUNSCHTE E-MAILS (SPAM).
            </div>
        </div>

        <div style="text-align : justify;">
           Ihr Konto wurde erstellt. Es ist jedoch notwendig, um sie zu aktivieren aus Ihre E-Mail-Box hat.
            Ein Aktivierungsschlüssel ist auf die angegebene E-Mail-Adresse gesendet wurde
            Wenn Sie eine Nachricht per E-Mail nicht erhalten, überprüfen Sie es nicht in Ihrem Junk-Mail.
            <br><br>
            Sie haben 7 Tage, um Ihr Konto zu aktivieren, bevor sie endgültig gelöscht.
        </div>';
