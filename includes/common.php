...
{	
	...
	if($USER['user_deleted'] == 1) {
		ShowErrorPage::printError(sprintf($LNG['sys_account_deleted'],$USER['username']), false);
	...
	ShowErrorPage::printError("<font size=\"6px\">".$LNG['css_account_banned_message']."</font><br><br>".sprintf($LNG['css_account_banned_expire'], _date($LNG['php_tdformat'], $USER['banaday'], $USER['timezone'])), false);	
