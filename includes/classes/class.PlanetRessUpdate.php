...
#		$this->CONF['energySpeed']	= 1;
	...
	private function ExecCalc()
	{
		...
		{
			$this->PLANET['civil']      = $this->PLANET['civil'] + $CivilTheorical;
		}
	...
	public function ReBuildCache()
	{
		...
		if($this->PLANET['energy_used'] == 0) {
			...
			$this->PLANET['metal_perhour']		= (($temp[901]['plus'] * (1 + $this->USER['factor']['Resource'] + 0.02 * $this->USER[$resource[140]]) * $prodLevel + $temp[901]['minus']) + (($temp[901]['plus'] * (1 + $this->USER['factor']['Resource'] + 0.02 * $this->USER[$resource[140]]) * $prodLevel + $temp[901]['minus']) /100 * $this->PLANET['colo_metal'])) * 20;
			$this->PLANET['metal_perhour'] += $this->PLANET['metal_perhour'] / 100 * 0.0002 * $this->PLANET['civil'];
			$this->PLANET['crystal_perhour']	= (($temp[902]['plus'] * (1 + $this->USER['factor']['Resource'] + 0.02 * $this->USER[$resource[140]]) * $prodLevel + $temp[902]['minus']) + (($temp[902]['plus'] * (1 + $this->USER['factor']['Resource'] + 0.02 * $this->USER[$resource[140]]) * $prodLevel + $temp[902]['minus']) / 100 * $this->PLANET['colo_crystal'])) * 20;
			$this->PLANET['crystal_perhour'] += $this->PLANET['crystal_perhour'] / 100 * 0.0002 * $this->PLANET['civil'];
			$this->PLANET['deuterium_perhour']	= (($temp[903]['plus'] * (1 + $this->USER['factor']['Resource'] + 0.02 * $this->USER[$resource[140]]) * $prodLevel + $temp[903]['minus']) + (($temp[903]['plus'] * (1 + $this->USER['factor']['Resource'] + 0.02 * $this->USER[$resource[140]]) * $prodLevel + $temp[903]['minus']) / 100 * $this->PLANET['colo_deut'])) * 20;
			$this->PLANET['deuterium_perhour'] += $this->PLANET['deuterium_perhour'] / 100 * 0.0002 * $this->PLANET['civil'];
			$this->PLANET['elyrium_perhour']	= (($temp[904]['plus'] * (1 + $this->USER['factor']['Resource'] + 0.02 * $this->USER[$resource[140]]) * $prodLevel + $temp[904]['minus']) + (($temp[904]['plus'] * (1 + $this->USER['factor']['Resource'] + 0.02 * $this->USER[$resource[140]]) * $prodLevel + $temp[904]['minus']) / 100 * $this->PLANET['colo_elyrium'])) * 20;
			$this->PLANET['elyrium_perhour'] += $this->PLANET['elyrium_perhour'] / 100 * 0.0002 * $this->PLANET['civil'];
