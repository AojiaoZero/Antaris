	...
	function buildCache()
	{
		...
		while($varsRow = $GLOBALS['DATABASE']->fetch_array($varsResult)) {
			...
			$ProdGrid[$varsRow['elementID']]['production']	= array(
				...
				904	=> $varsRow['production904'],
				905	=> $varsRow['production905'],
			...
			switch($varsRow['class']) {
				...
				break;
				case 300: 
					$reslist['population'][]	= $varsRow['elementID'];
				break;
				case 400: 
				...
				break;
				case 800: 
					$reslist['items'][]	= $varsRow['elementID'];
				break;
			}
		}
