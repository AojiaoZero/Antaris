...
class FleetFunctions 
{
	...
	{
		global $resource;
		return 1 + $USER[$resource[141]] + $USER['factor']['FleetSlots'];
	}
	...
	public static function CheckBashPortal($Target)
	{
		global $USER;
		if(!BASH_ON)
			return false;
