...
class MissionCaseSpy extends MissionFunctions
{
	...
	function TargetEvent()
	{
		...
		SendSimpleMessage($this->_fleet['fleet_owner'], 0, $this->_fleet['fleet_start_time'], 0, sprintf($LNG['sys_mess_tower_spy_ownerbis'],$this->getPlanetName($this->_fleet['fleet_end_id']), $this->_fleet['fleet_end_system'], $this->_fleet['fleet_end_planet']), $LNG['sys_mess_spy_report'], $spyRaport);
		...
		SendSimpleMessage($this->_fleet['fleet_target_owner'], 0, $this->_fleet['fleet_start_time'], 0, $LNG['sys_mess_tower_spy_targetbis'], $LNG['sys_mess_spy_activity'], '<div class="conteneur_message"><div style="text-align : justify;">'.$LNG['fleet_spy_1'].' '.$this->getUsername($StartOwner).' <span class="orange">[SGCF]</span> '.$LNG['fleet_spy_2'].' home001 ['.$this->_fleet['fleet_end_system'].':'.$this->_fleet['fleet_end_planet'].']. '.$LNG['fleet_spy_3'].' :
    </div>
