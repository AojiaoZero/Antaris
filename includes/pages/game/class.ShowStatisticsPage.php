            ...
            case 1:
                ...
                while ($StatRow = $GLOBALS['DATABASE']->fetch_array($query))
                {
                    ...
                    $RangeList[]	= array(
                        ...
                        'ranking'	=> $StatRow['history_total_rank'] - $StatRow[$Rank],
                    );
                }
            ...
            case 2:
                ...
                while ($StatRow = $GLOBALS['DATABASE']->fetch_array($query))
                {
                    $RangeList[]	= array(
                        ...
                        'ally_request_notallow'		=> $StatRow['ally_request_notallow'],
                        'tag'		=> $StatRow['ally_tag'],
                        'members'	=> $StatRow['ally_members'],
                        'ally_owner'	=> $StatRow['ally_owner'],
                        'rank'		=> $StatRow[$Rank],
                        'usernale'		=> $this->getUsername($StatRow['ally_owner']),
