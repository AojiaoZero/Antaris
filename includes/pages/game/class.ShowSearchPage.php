	...
	static function _getSearchList($seachMode, $searchText, $maxResult)
	{
		...
		switch($seachMode) {
			case 'playername':
				...
				a.id, a.username, a.planet_cloak, a.avatar, a.ally_id, a.galaxy, a.system, a.planet, b.name, c.total_rank, c.total_points, d.ally_name
				FROM ".USERS." as a 
			...
			case 'planetname':
				$searchResult = $GLOBALS['DATABASE']->query("SELECT 
				a.name, a.galaxy, b.avatar, a.planet, a.system,
			...
			case "allyname":
				$searchResult = $GLOBALS['DATABASE']->query("SELECT 
				a.ally_name, a.ally_request_notallow, c.username, c.avatar, a.ally_tag, a.ally_owner, a.ally_members, 
