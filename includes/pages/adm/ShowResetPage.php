...
function ShowResetPage()
{
	...
	{		
		...
		foreach($reslist['population'] as $ID)
		{
			$dbcol['population'][$ID]	= "`".$resource[$ID]."` = '0'";
		}
		...
		// populas Y DEFENSAS
		if ($_POST['population']	==	'on')
			$GLOBALS['DATABASE']->query("UPDATE ".PLANETS." SET ".implode(", ",$dbcol['population'])." WHERE `universe` = ".$_SESSION['adminuni'].";");
		if ($_POST['population']	==	'on')
			$GLOBALS['DATABASE']->query("UPDATE ".PLANETS." SET `civil_prod` = '0', `technician_prod` = '0', `scientist_prod` = '0', `archaeologist_prod` = '0', `diplomat_prod` = '0', `soldier_prod` = '0', `adv_soldier_prod` = '0' WHERE `universe` = ".$_SESSION['adminuni'].";");
		...
		if ($_POST['resources']	==	'on')
			$GLOBALS['DATABASE']->query("UPDATE ".PLANETS." SET formation = '0', formation_used = '0' WHERE `universe` = ".$_SESSION['adminuni'].";");
